...
if($_POST && isset($_POST['submit'])){
    ...
    $transactionRequestBean->setCustomerName('abhinav');
    ...
    if(is_string($response) && strstr($response, 'msg=')){
...
<form method="post">
    ...
    <tr>
        ...
        <td><input type="text" name="mrctCode" value="T3135"/></td>
    </tr>
	<tr>
    ...
    <tr>
     ...
     <tr>
        ...
        <td><select name="locatorURL">
				...
				<option value="https://www.tpsl-india.in/PaymentGateway/services/TransactionDetailsNew">LIVE</option>
